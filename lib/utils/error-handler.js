...
var exitCode = 0     // 退出码，参考 linux 里的退出码
...
/**
 * 入口文件  errorHandler.exit()
 * @param {*} code 0
 * @param {*} noLog 
 */
function exit (code, noLog) {
  // process.exitCode  进程正常结束时的状态码
  exitCode = exitCode || process.exitCode || code

  console.log('npm.config.loaded is ', npm.config.loaded)
  console.log("npm.config.get('_exit') is ", npm.config.get('_exit'))
